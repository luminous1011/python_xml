...
try:
    ...
    create_main_table_sql = """create table CAVT_main_tb(
    ...
    create_second_table_sql = """create table CAVT_sec_tb(
            ...
            while i < len(testArr):
                ...
                if re.match('</image', lineContent):
                    cur.execute(
                        ...
                        label, points, occluded,image_id,image_name,image_width,image_height) VALUE \
                ...
                i += 1
            cur.execute(
                "INSERT INTO CAVT_main_tb(xid,name, size, mode, overlap, bugtracker,created,updated,start_frame,stop_frame,frame_filter,z_order) VALUE \
                ('" + PRIMARY_TABLE_KEYS['id'] + "','" +PRIMARY_TABLE_KEYS['name']   \
                + "','" +PRIMARY_TABLE_KEYS['size'] + "', '" + PRIMARY_TABLE_KEYS['mode'] + "','" + PRIMARY_TABLE_KEYS['overlap'] \
                + "','" +PRIMARY_TABLE_KEYS['bugtracker'] + "', '" + PRIMARY_TABLE_KEYS['created'] + "','" + PRIMARY_TABLE_KEYS['updated'] \
                + "','" +PRIMARY_TABLE_KEYS['start_frame'] + "', '" + PRIMARY_TABLE_KEYS['stop_frame'] + "','" + PRIMARY_TABLE_KEYS['frame_filter'] \
                + "','" +PRIMARY_TABLE_KEYS['z_order'] + "')")
